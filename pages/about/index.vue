<template>
    <main class="container mt-16 mb-20">
        <div class="grid grid-cols-1 gap-6 mx-6 sm:grid-cols-2 sm:mx-20">
            ...
            <div class="bg-blue-100 py-6 px-10 rounded-lg">
                <h1 class="text-3xl font-bold text-black">Abimanyu Darmawan</h1>
                <p class="text-gray-600 mb-4">Frontend & Graphic Designer</p>
                <div class="grid grid-cols-1 gap-1 sm:grid-cols-3">
                    <div>
                        <p class="font-medium mt-2">Frontend with: </p>
                    ...
                    <div>
                        <p class="font-medium mt-2">Other langs: </p>
                        <ul class="text-sm list-disc ml-4">
                            <li><p>C#</p></li>
                            <li><p>PHP</p></li>
                            <li><p>Dart</p></li>
                            <li><p>Lua</p></li>
                            <li><p>NodeJS/ExpressJS</p></li>
                        </ul>
                    </div>
                    <div>
                        <p class="font-medium mt-2">Tools: </p>
                        <ul class="text-sm list-disc ml-4">
                            <li><p>VSCode/Nvim</p></li>
                            <li><p>Git</p></li>
                            <li><p>Postman/Thunder</p></li>
                        </ul>
                    </div>
                </div>
            </div>
